...
//若之前唤醒过屏幕则释放之使屏幕不保持常亮
    ...
    public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        if (System.currentTimeMillis() - lastLong > 1000) {
...
//若查找到打开按钮则模拟点击
    ...
    public void onInterrupt() {
        Toast.makeText(this, "服务被中断啦~", Toast.LENGTH_LONG).show();
    }
...
//        player = MediaPlayer.create(this, R.raw.songtip_m);
        ...
        Toast.makeText(this, "_已开启服务_", Toast.LENGTH_LONG).show();
    }
    ...
    public void onDestroy() {
        ...
        Log.i("demo", "关闭");
        wakeAndUnlock(false);
        Toast.makeText(this, "_已关闭服务_", Toast.LENGTH_LONG).show();
    }
}
