package net.dunyun.framework.android.mainapp.fund.widget;
...
import net.dunyun.framework.android.mainapp.fund.common.AppUtil;
import net.dunyun.framework.android.mainapp.fund.common.Constants;
import net.dunyun.framework.android.mainapp.fund.entity.GesturePoint;
...
public class GestureDrawline extends View {
	...
	public GestureDrawline(Context context, List<GesturePoint> list, boolean isVerify,
		...
		paint.setColor(Color.rgb(113, 201, 249));// ����Ĭ��������ɫ
