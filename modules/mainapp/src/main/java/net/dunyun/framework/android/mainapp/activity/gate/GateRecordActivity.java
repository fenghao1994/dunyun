...
import net.dunyun.framework.android.mainapp.fragment.GateRecordFragment;
 ...
 * @Copyright:
 */
public class GateRecordActivity extends BaseFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gate_record);
    ...
    private void initFragments() {
        ...
        int i = 0;
        while (i < 2) {
            BaseFragment recordFragment = new GateRecordFragment();
            Bundle args = new Bundle();
            args.putString("communityId", keyChainVo.getCommunityId());
            args.putString("logType", "" + types[i]);
